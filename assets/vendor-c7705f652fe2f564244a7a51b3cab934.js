...
return u&&a.remove(u,o.lid),null===s&&null===u||(null===s&&null!==u||s&&!s.hasRecord&&u&&u.hasRecord)&&(s&&a.remove(s,i.lid),(s=u)._id=i.id,a.add(s,i.lid)),i})),this._identityMap=new Oe}var t=e.prototype
...
return n.shouldReloadAll(this,i)?(Ember.set(t,"isUpdating",!0),H(Ie(n,this,e,r))):(!1===r.backgroundReload||(r.backgroundReload||n.shouldBackgroundReloadAll(this,i))&&(Ember.set(t,"isUpdating",!0),Ie(n,this,e,r)),H(Ember.RSVP.Promise.resolve(t)))},h._didUpdateAll=function(e){this.recordArrayManager._didUpdateAll(e)},h.peekAll=function(e){var t=i(e)
...
return e}(e):t}function l(e){return(l=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}var c=Ember._componentManagerCapabilities("3.13",{destructor:!0,asyncLifecycleCallbacks:!1,updateHook:!1}),h=function(e,t){e.isDestroyed||(Ember.destroy(e),t.setSourceDestroyed(),(0,r.setDestroyed)(e))},d=function(e){if(!e.isDestroying){var t=Ember.meta(e)
t.setSourceDestroying(),(0,r.setDestroying)(e),Ember.run.schedule("actions",e,e.willDestroy),Ember.run.schedule("destroy",void 0,h,e,t)}},f=function(e){(function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
...
return r}},{key:"destroyComponent",value:function(e){d(e)}}])&&i(t.prototype,r),u&&i(t,u),h}((0,t.default)(Ember.setOwner,Ember.getOwner,c))
var p=f
...
return(e=Ember.FEATURES).isEnabled.apply(e,arguments)},Object.defineProperty(e,"__esModule",{value:!0})}))
